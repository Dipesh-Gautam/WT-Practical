...
<body>
    ...
    <form method="post"  onsubmit="return validate();">
        <table class="Tpass">
            ...
            <tr>
            <td><input type="text" name="password" class="edit_password" placeholder="Enter your new password"></td>
            <tr>
            ...
            <tr>
            <td><input type="Submit" name="Submit" class ="btn pass" value="Change"></td>
            </tr>
        </table>
